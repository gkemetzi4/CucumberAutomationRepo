...
public class MultipleScenarioStepDef {
	...
	public void user_is_on_the_FB_login_page() throws InterruptedException {
		...
		//Thread.sleep(4000);
		driver.findElement(By.xpath("//*[@id=\"u_0_k\"]")).click(); //cookie consent
		//Thread.sleep(4000);
	...
	public void user_enters_surname() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"u_2_d\"]")).sendKeys("Tzi");
		Thread.sleep(1000);
	}
	...
	public void user_mobile_field_should_be_blank() throws InterruptedException {
		...
		String mobileActual = driver.findElement(By.xpath("//*[@id=\"u_5_g\"]")).getAttribute("value");
